...
export const USER_DETAILS_DELETE_REQUEST = "USER_DETAILS_DELETE_REQUEST";
export const USER_DETAILS_DELETE_SUCCESS = "USER_DETAILS_DELETE_SUCCESS";
export const USER_DETAILS_DELETE_FAIL = "USER_DETAILS_DELETE_FAIL";
